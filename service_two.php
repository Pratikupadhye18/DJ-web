...
<html lang="en">
	<head>
		...
		<!-- SITE TITLE -->
		<title>Chorbi - Service Two Page</title>			
...
<body>
	...
	<!--START SERVICE -->
	<div class="service_home_two section-padding">
		<div class="container">
			...
			<div class="row">					
				<div class="col-md-6 col-sm-6 col-xs-12">
					<div class="single_service_two">
						<span class="ti-medall"></span>
						<h3>Constant Free Service</h3>
				...
				<div class="col-md-6 col-sm-6 col-xs-12">
					<div class="single_service_two">
						...
						<h3>Any time Customer support</h3>
						<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Beatae accusantium  consectetur.</p>
					</div>
				</div><!--END COL -->
			</div><!--END ROW -->		
					...
					<div id="testimonial-slider" class="owl-carousel">
						<div class="testimonial">
							...
							<div class="testi_pic_title tpt_one">
								<div class="pic">
									<img src="assets/img/testimonial/img-1.jpeg" alt="">
								</div>
								<h4>James Clayton</h4>
						...
						<div class="testimonial">
							...
							<div class="testi_pic_title tpt_two">
								<div class="pic">
									<img src="assets/img/testimonial/img-2.jpeg" alt="">
								</div>
								<h4>James Simmons</h4>
						...
						<div class="testimonial">
							...
							<div class="testi_pic_title tpt_three">
								<div class="pic">
									<img src="assets/img/testimonial/img-3.jpeg" alt="">
								</div>
								<h4>Alex feroundo</h4>
