                        ...
                        <div class="tab-pane" id="uidesign">
                            ...
                            <?php if ($f_id_data) { ?>
                                <div class="image_upload_div">
                                    <form action="upload_tour.php" method="post" class="dropzone" id="HomeSlideGallery">
                            ...
                            <?php if ($f_id_data) { ?>
                                <form name="r" id="form_mul_ref" method="post" action="">
                                    <div class="buttonContainer" style="text-align: center;">
                                        ...
                                        <p><a href="tour.php" class="btn btn-success green"><i class="fa fa-arrow-circle-left"> Back to Tour</i></a>
                                        <button class="btn btn-success green" type="submit" name="refresh" onClick="return gallery()"><i class="fa fa-refresh"> Refresh Images</i></button></p>
                                    </div>
                                </form>
                            <?php } ?>
                            ...
                            <form name="k" id="form_mul_del" method="post" action="">
                                <ul class="img_ul" id="sortable">
                                    ...
                                    if (!empty($f_id_data)) {
                                        ...
                                        try {
                                            $now = date('Y-m-d');
                                            $stmt = $conn->prepare("SELECT * FROM pro_images WHERE s_id='" . $f_id_data . "' ORDER BY image_id ASC");
                                            $stmt->execute();
                                            foreach ($stmt as $row) {

                                                echo '<li class="img_li" id="menu-order-' . $row['image_id'] . '">
                                            <figure style="height: auto">
                                                <img src="../uploads/tour/' . $row['s_id'] . '/' . $row['file_name'] . '" />
                                            </figure>
                                        ...
                                        $pdo->close();
                                        //$fetch = mysqli_query($conn, "SELECT * FROM pro_images WHERE s_id='" . $f_id_data . "' ORDER BY image_id ASC");
                                    }
                                    ?>
                                </ul>
                            </form>
