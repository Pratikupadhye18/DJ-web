...
<div class="modal fade" id="addnew">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <form class="form-horizontal" method="POST" action="crew_add7.php" enctype="multipart/form-data">
...
<div class="modal fade" id="delete">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form class="form-horizontal" method="POST" action="crew_delete7.php">
                    <input type="hidden" class="srid" name="id">
...
<div class="modal fade" id="edit">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form class="form-horizontal" method="POST" action="crew_edit7.php" enctype="multipart/form-data">
                    <input type="hidden" class="srid" name="id">
