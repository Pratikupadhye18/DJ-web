...
<div class="modal fade" id="addnew">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <form class="form-horizontal" method="POST" action="crew_add2.php" enctype="multipart/form-data">
            <div class="modal-body">
                    ...
                    <div class="form-group">
                        <div class="col-sm-12">
                            <input type="text" class="form-control" id="desc" name="descr" >
                        </div>
                    </div>
                    <p><b>Page</b></p>
                    <div class="form-group">
...
<div class="modal fade" id="delete">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form class="form-horizontal" method="POST" action="crew_delete2.php">
                    <input type="hidden" class="srid" name="id">
...
<div class="modal fade" id="edit">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form class="form-horizontal" method="POST" action="crew_edit2.php" enctype="multipart/form-data">
                    <input type="hidden" class="srid" name="id">
                    
                    <div class="form-group">
                        <label for="edit_name" class="col-sm-1 control-label">Meta Title</label>
                        <div class="col-sm-11">
                            <input type="text" class="form-control" id="edit_name" name="name" >
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="edit_name" class="col-sm-1 control-label">Meta Description</label>
                        <div class="col-sm-11">
                            <input type="text" class="form-control" id="edit_desc" name="descr" >
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="edit_name" class="col-sm-1 control-label">Page</label>
                        <div class="col-sm-11">
