...
<body class="hold-transition skin-blue sidebar-mini">
    <div class="wrapper">
        ...
        <h1>
    Institutions We Provide Staffing Services For List
            </h1>
                <ol class="breadcrumb">
                    <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
<li>Institutions We Provide Staffing Services For</li>
                    <li class="active">Institutions We Provide Staffing Services For List</li>
                </ol>
            </section>
    ...
    //                  }
        ...
        <?php include 'includes/institutions_modal.php'; ?>
    </div>
    <!-- ./wrapper -->
