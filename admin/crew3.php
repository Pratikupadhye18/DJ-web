...
<body class="hold-transition skin-blue sidebar-mini">
    <div class="wrapper">
        ...
        <div class="content-wrapper">
            ...
            <section class="content-header">
                ...
                <ol class="breadcrumb">
                    ...
                    <li>Inner Page Banner</li>
                    <li class="active">Inner Page Banner</li>
                </ol>
            </section>
                            ...
                            <div class="box-body">
                                <table id="example1" class="table table-bordered">
                                    ...
                                    <tbody>
                                        ...
                                        try {
                                            $now = date('Y-m-d');
                    						$stmt = $conn->prepare("SELECT * FROM crew3");
                                            $stmt->execute();
                                            foreach ($stmt as $row) {
                                            $image = (!empty($row['photo'])) ? '../uploads/inner_pages/' . $row['photo'] : '../images/no-image.jpg';
                                            echo "
					                          <tr>
					                            <td>" . strtoupper($row['cate']) . "</td>
					                            <td>" . $row['name'] . "</td>
					                            <td>
        ...
        <?php include 'includes/crew_modal3.php'; ?>
    </div>
    <!-- ./wrapper -->
